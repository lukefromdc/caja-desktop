                                             ...
                                             NautilusFile      *target_file)
{
		...
		/*Theme this like eel-editable-label for caja-desktop builds*/
		gtk_widget_set_name(view->details->rename_file_popover, "rename_file_popover");
		...
		gtk_css_provider_load_from_data (cssProvider,
										...
										"font-size: 0pt;\n"
										"}" 
										"#rename_file_popover>grid{\n"
										"min-width: 0px;\n"
										"padding: 0px;\n"
   										"margin: 0px;\n"
										"}" 
										"#rename_file_popover>grid>label{\n"
										"color: transparent;\n"
    									"font-size: 0pt;\n"
										"}",-1, NULL);
